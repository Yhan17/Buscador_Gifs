  ...
  _getGifs() async {
    ...
    if (_search == null) {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/trending?api_key=SUA_API_AQUI&limit=20&rating=G");
    } else {
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=SUA_API_AQUI&q=$_search&limit=25&offset=$_offset&rating=G&lang=en");
    }
